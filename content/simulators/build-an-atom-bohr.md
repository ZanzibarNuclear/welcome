...
1. **Add Protons**: Click the proton button to add protons to the nucleus
2. **Add Neutrons**: Add neutrons to create different isotopes
3. **Add Electrons**: Balance electrons to create neutral atoms or ions
4. **Observe**: Watch the element name, symbol, and properties update
