...
Use the same steps as [Atom Builder (Bohr)](/simulators/build-an-atom-bohr): add protons, neutrons, and electrons and watch the element, mass number, and charge update. Compare the two simulators to connect the shell picture with a more modern mental model.
