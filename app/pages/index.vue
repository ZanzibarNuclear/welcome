...
<template>
  <div>
    ...
    <!-- Hero Text -->
    <section class="py-16 px-6 flex flex-col items-center text-center">
      <div class="max-w-3xl">
        <h1 class="text-5xl font-extrabold text-cherenkov-400 dark:text-cherenkov-300 mb-6 tracking-tight">Everything is
          Atoms</h1>
